...
<html>
  ...
  <body>
    <?
      ...
      $mode=""; //오류 방지를 위한 초기화
      $search = htmlspecialchars($_POST['searchbox']); //searchbox에서 값을 받아옵니다. (텍스트박스)
      $find = htmlspecialchars($_POST['find']); //find에서 값을 받아옵니다. (셀렉트 박스)
          ...
          <div class="row" style="margin-bottom:20px;">
            <div class="col-md-12 col-sm-12">
              <font size="4">&nbsp;총 <?= $total_record ?>개의 게시물이 있습니다.</font> <!--게시글 갯수 -->
                  ...
                  {
                ?>
                  &nbsp;&nbsp;<a href="community.php"><input type="button" value="목록으로 돌아가기" class="btn btn-default"></a> <!-- 목록 -->
                <?
                  }
                  else{
                ?>
