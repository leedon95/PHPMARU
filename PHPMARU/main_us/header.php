    		...
    		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
              ...
              <li>
                ...
                <ul class="dropdown-menu">
                  <li><a href="main.php">US</a></li>
                  <li><a href="../main_kr/main.php">KR</a></li>
                </ul>
    					</li>
    					<? if(empty($_SESSION['usernick'])) {
                echo "<li><a href='Login.php'>Login</a></li>";  // 로그인 되어있으면 닉네임 출력 or 로그인 아닐시 로그인 출력
              } else {
                echo "<li><a>Welcome".($_SESSION['usernick'])."</a></li>";
              }?>
              <? if(empty($_SESSION['usernick'])) {
                echo "<li><a href='SignUp.php'>SignUp</a></li>";  // 로그인 되어있으면 로그아웃 출력 or 로그인 아닐시 회원가입 출력
              } else {
                echo "<li><a href='logout.php'>Logout</a></li>";
              }?>
              <? if(empty($_SESSION['usernick'])) {
                echo "<li><a href='findid.php'>Find Id or Password</a></li>";  // 로그인 아닐시 아이디 비번 찾기
              }?>
    ...
    <nav style="margin-top:30px;"> <!-- nav : 상단 메뉴입니다. -->
      <div class="row" align="center">
        <div class="col-md-3 col-sm-6">
            <a href="Introduce.php" class="ghost-buttonNav">Introduce</a>
        </div>
        <div class="col-md-3 col-sm-6">
            <a href="notice.php" class="ghost-buttonNav">Notice</a>
        </div>
        <div class="col-md-3 col-sm-6">
            <a href="board/Community.php" class="ghost-buttonNav">Community</a>
        </div>
        <div class="col-md-3 col-sm-6">
            <a href="DownLoadsolution.php" class="ghost-buttonNav">Download</a>
        </div>
      </div></div> <!-- row  -->
    </nav> <!-- 메뉴 끝 -->
</body>
